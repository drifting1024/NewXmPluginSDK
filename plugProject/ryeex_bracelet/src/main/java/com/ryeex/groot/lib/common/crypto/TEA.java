/**
 * Implementation of the Tiny Encryption Algorithm (TEA). The Tiny Encryption Algorithm is one of
 * the fastest and most efficient cryptographic algorithms in existence. It was developed by David
 * Wheeler and Roger Needham at the Computer Laboratory of Cambridge University. See
 * http://www.cl.cam.ac.uk/ftp/users/djw3/tea.ps This software was written to provide simple
 * encryption for J2ME. The homepage for this software is http://winterwell.com/software/TEA.php (c)
 * 2008 Joe Halliwell <joe.halliwell@gmail.com> This program is free software: you can redistribute
