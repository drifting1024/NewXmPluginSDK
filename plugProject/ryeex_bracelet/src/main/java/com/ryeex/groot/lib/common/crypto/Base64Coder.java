...
/**
 * <p>
 * Encodes and decodes to and from Base64Coder notation.
 * </p>
 * <p>
 ...
 * Also added these Base64Coder dialects:
 * <ol>
 * <li>The default is RFC3548 format.</li>
 * <li>Calling Base64Coder.setFormat(Base64Coder.BASE64_FORMAT.URLSAFE_FORMAT) generates URL and
 * file name friendly format as described in Section 4 of RFC3548.
 * http://www.faqs.org/rfcs/rfc3548.html</li>
 * <li>Calling Base64Coder.setFormat(Base64Coder.BASE64_FORMAT.ORDERED_FORMAT) generates URL and
 * file name friendly format that preserves lexical ordering as described in
 * http://www.faqs.org/qa/rfcc-1940.html</li>
 * </ol>
 * Special thanks to Jim Kellerman at
 * <a href="http://www.powerset.com/">http://www.powerset.com/</a> for contributing the new
 * Base64Coder dialects.</li>
...
public class Base64Coder {
    ...
    /**
     * Encode using Base64Coder-like encoding that is URL- and Filename-safe as described in Section
     * 4 of RFC3548:
     * <a href="http://www.faqs.org/rfcs/rfc3548.html" >http://www.faqs.org/rfcs/rfc3548.html</a>.
     * It is important to note that data encoded this way is <em>not</em> officially valid
     * Base64Coder, or at the very least should not be called Base64Coder without also specifying
    ...
    /**
     * Translates a Base64Coder value to either its 6-bit reconstruction value or a negative number
     ...
     * array in Base64Coder notation. The actual number of significant bytes in your array is given
     ...
     * Base64Coder bytes to <var>destination</var>. The source and destination arrays can be
     * manipulated anywhere along their length by specifying <var>srcOffset</var> and
     * <var>destOffset</var>. This method does not check to make sure your arrays are large enough
     * to accomodate <var>srcOffset</var> + 3 for the <var>source</var> array or
    ...
    /**
     * Serializes an object and returns the Base64Coder-encoded version of that serialized object.
     * If the object cannot be serialized or there is another error, the method will return
     * <tt>null</tt>. The object is not GZip-compressed before being encoded.
     *
     ...
     * <p>
     * Example: <code>encodeObject( myObj, Base64Coder.GZIP | Base64Coder.DONT_BREAK_LINES
     * )</code>
     *
     * @param serializableObject The object to encode
    ...
    /**
     * Encodes a byte array into Base64Coder notation. Does not GZip-compress data.
     *
     ...
     * <p>
     * Example: <code>encodeBytes( myData, Base64Coder.GZIP | Base64Coder.DONT_BREAK_LINES
     * )</code>
     *
     * @param source The data to convert
     * @param options Specified options
     ...
     * @param off Offset in array where conversion should begin
     * @param len Length of data to convert
     * @param options Specified options; alphabet type is pulled from this (standard, url-safe,
     *            ordered)
     * @see Base64Coder#GZIP
     * @see Base64Coder#DONT_BREAK_LINES
     * @since 2.0
     ...
     * converted from the Base64Coder encoding.
     * <p>
    ...
    public static byte[] decode(byte[] source, int off, int len, int options) {
        ...
        for (i = off; i < off + len; i++) {
            ...
            // better
            {
                ...
                System.err.println(
                        "Bad Base64Coder input character at " + i + ": " + source[i]
                                + "(decimal)");
                return null;
            } // end else:
    ...
    /**
     * Decodes data from Base64Coder notation, automatically detecting gzip-compressed data and
     * decompressing it.
     *
    ...
    /**
     * Attempts to decode Base64Coder data and deserialize a Java Object within. Returns
    ...
    public static byte[] decodeFromFile(String filename) {
        ...
        try {
            ...
            if (file.length() > Integer.MAX_VALUE) {
                System.err.println(
                        "File is too big for this convenience method (" + file
                                .length()
                                + " bytes).");
                return null;
    ...
    public static String encodeFromFile(String filename) {
        return encodeFromFile(filename, Base64Coder.ENCODE);
    }
     ...
     * @since 2.1
     */
    public static String encodeFromFile(String filename, int option) {
        ...
        try {
            ...
            byte[] buffer = new byte[Math
                    .max((int) (file.length() * 1.4), 40)]; // Need
            // max()
            // for
            // math
            // on
            ...
            encodedData = new String(buffer, 0, length,
                    Base64Coder.PREFERRED_ENCODING);
    ...
    /**
     * A {@link Base64Coder.InputStream} will read data from another <tt>java.io.InputStream</tt>,
     * given in the constructor, and encode/decode to/from Base64Coder notation on the fly.
     *
     * @see Base64Coder
     * @since 1.3
     */
    public static class InputStream extends java.io.FilterInputStream {
        ...
        /**
         * Constructs a {@link Base64Coder.InputStream} in either ENCODE or DECODE mode.
         * <p>
         * Valid options:
         *
         * <pre>
         ...
         * </pre>
         * <p>
         * Example: <code>new Base64Coder.InputStream( in, Base64Coder.DECODE
         * )</code>
         *
         * @param in the <tt>java.io.InputStream</tt> from which to read data.
         * @param options Specified options
        ...
        /**
         * Reads enough of the input stream to convert to/from Base64Coder and returns the next
         * byte.
         *
         * @return next byte
         * @since 1.3
        ...
        public int read() throws java.io.IOException {
                ...
                // Else decoding
                    ...
                    if (i == 4) {
                        ...
                        throw new java.io.IOException(
                                "Improperly padded Base64Coder input.");
                    } // end
            ...
            // Else error
                ...
                throw new java.io.IOException(
                        "Error in Base64Coder code reading stream.");
            } // end else
        } // end read
    ...
    /**
     * A {@link Base64Coder.OutputStream} will write data to another <tt>java.io.OutputStream</tt>,
     * given in the constructor, and encode/decode to/from Base64Coder notation on the fly.
     *
     * @see Base64Coder
     * @since 1.3
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
        ...
        /**
         * Constructs a {@link Base64Coder.OutputStream} in either ENCODE or DECODE mode.
         * <p>
         * Valid options:
         *
         * <pre>
         ...
         * </pre>
         * <p>
         * Example: <code>new Base64Coder.OutputStream( out, Base64Coder.ENCODE
         * )</code>
         *
         * @param out the <tt>java.io.OutputStream</tt> to which data will be written.
         * @param options Specified options.
        ...
        /**
         * Writes the byte to the output stream after converting to/from Base64Coder notation. When
        ...
        public void write(int theByte) throws java.io.IOException {
            ...
            // Else, Decoding
                ...
                if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
                    ...
                    throw new java.io.IOException(
                            "Invalid character in Base64Coder data.");
        ...
        public void flushBase64() throws java.io.IOException {
            if (position > 0) {
                if (encode) {
                    ...
                    throw new java.io.IOException(
                            "Base64Coder input not properly padded.");
                } // end else: decoding
