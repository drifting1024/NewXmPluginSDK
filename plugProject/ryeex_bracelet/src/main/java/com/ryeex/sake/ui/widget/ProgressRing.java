package com.ryeex.sake.ui.widget;
...
public class ProgressRing extends View {
    ...
    public ProgressRing(Context context, @Nullable AttributeSet attrs) {
        ...
        progressStartColor = ta.getColor(R.styleable.ProgressRing_baseui_progress_ring_progress_start_color, Color.YELLOW);
        progressEndColor = ta.getColor(R.styleable.ProgressRing_baseui_progress_ring_progress_end_color, progressStartColor);
        bgStartColor = ta.getColor(R.styleable.ProgressRing_baseui_progress_ring_bg_start_color, Color.LTGRAY);
        bgMidColor = ta.getColor(R.styleable.ProgressRing_baseui_progress_ring_bg_mid_color, bgStartColor);
        bgEndColor = ta.getColor(R.styleable.ProgressRing_baseui_progress_ring_bg_end_color, bgStartColor);
        progress = ta.getInt(R.styleable.ProgressRing_baseui_progress_ring_progress, 0);
        progressWidth = ta.getDimension(R.styleable.ProgressRing_baseui_progress_ring_progress_width, 8f);
        startAngle = ta.getInt(R.styleable.ProgressRing_baseui_progress_ring_start_angle, 150);
        sweepAngle = ta.getInt(R.styleable.ProgressRing_baseui_progress_ring_sweep_angle, 240);
        showAnim = ta.getBoolean(R.styleable.ProgressRing_baseui_progress_ring_show_anim, true);
        ta.recycle();
